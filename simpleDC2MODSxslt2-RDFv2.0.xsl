...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:sru_dc="info:srw/schema/1/dc-schema" xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="sru_dc oai_dc dc" version="2.0">
    ...
    <!-- 20140508 Kim Pham: This xslt version 2.0 stylesheet is been adapted to transform DC in RDF to MODS.  Note that dc:coverage has been collapsed into <subject><geographic> or <temporal> -->
    ...
    <xsl:template match="/">
        ...
        <xsl:if test="rdf:RDF/rdf:Description">
            <xsl:apply-templates/>
        </xsl:if>
    ...
    <xsl:template match="sru_dc:dc">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
			    <mods version="3.4" xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-4.xsd">
					<xsl:call-template name="dcMain"/>
				</mods>
			</xsl:otherwise>
		</xsl:choose>
