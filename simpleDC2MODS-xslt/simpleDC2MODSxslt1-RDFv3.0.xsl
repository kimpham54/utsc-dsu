...
<!-- 20140508 Kim Pham: This xslt version 1.0 stylesheet has been adapted to transform DC in RDF to MODS. -->  
<!-- Version Note: dc:coverage has been collapsed into <subject><geographic> -->
<!-- Used Transformer Saxon6.5.5 -->
